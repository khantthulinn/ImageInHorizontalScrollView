...
//    }
    ...
    NSInteger scrollviewWidth = scrollView.contentSize.width - scrollView.contentOffset.x;
    if (scrollviewWidth == CGRectGetWidth(scrollView.frame))
    {
        scrollView.panGestureRecognizer.enabled = NO;
    }
    else
    {
        [_photoBrowser.pagingScrollView.panGestureRecognizer requireGestureRecognizerToFail:scrollView.panGestureRecognizer];
    }
    
    
//    [self.delegate scrollViewDidZoomFromSubView:scrollView];
}
